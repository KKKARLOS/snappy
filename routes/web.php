...
Route::get('/', function () {
    ...
    //Usando Vistas
    //Vista basica
    // $pdf = PDF::loadView('pdf.tutorial0');
    // return $pdf->stream(); 
    ...
    $pdf = PDF::loadView('pdf.tutorial1',['cars' => $data ]);
    return $pdf->stream(); 
